...
import PercentageMetric from "@/components/percentage_metric/percentage_metric";
import { TestimonialContainer } from "@/components/testimonial_container/testimonial_container";
...
export default function Test() {
  return (
    <Layout>
      ...
      <div className="caseSection">
        <SectionHeader
          tag="Explore and Iterate"
          subheadline="I iterated on various design approaches that prioritized simplicity, and clarity while allowing granular control.  While iterating, I gathered initial feedback from stakeholders and ensured the feature was easy to discover without disrupting the flow of more frequent or critical user actions."
        />
      ...
      <div className="caseSection">
        ...
        <div className="gridWrapper pt-8 ">
          <SimpleImg
            image={
              { src: "/ach-fraud/desktop4.jpg", alt: "desktop4" }
            }
            variant="oneLarge"
          />
        </div>
        <div className="gridWrapper pt-8 ">
          <SimpleImg
            image={
              { src: "/ach-fraud/mobile3.jpg", alt: "mobile3" }
            }
            variant="oneLarge"
          />
        </div>
        ...
        <SectionHeader
          subheadline="We first launched the feature to a focused group of beta customers to test the adoption and gather feedback. We then launched the feature to all customers and measured the adoption of feature capabilities within the first two weeks."
        />
        <div className="pt-8 pb-8 flex flex-col gap-8 ">
          <PercentageMetric
            percentage={34}
            description="adoption of features with targeted beta customers in first two weeks"
          />
          <PercentageMetric
            percentage={20}
            description="of total customers configured controls within first two weeks of GA"
          />
        </div>
      ...
      <div className="caseSection">
        <SectionHeader tag="Recommendations" subheadline="Here's what my teammates at Bluevine had to say about our work together on this project:" />
          ...
          <TestimonialContainer 
            testimonials={[
              ...
              },
              {
                ...
                image: "/headshots/tim_resudek.jpeg"
              }
            ]}
            numberOfCards={2}
          />
